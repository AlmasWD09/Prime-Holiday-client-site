...
const Banner = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url(http://res.cloudinary.com/dzzyhqpnk/image/upload/v1735362515/ggcunfjclwi1fpcvw67n.png)",
      }}
    >
      {/* Content */}
      <div className="relative z-10 grid justify-center items-center h-[356px] lg:h-[550px] text-[#FFFFF0] py-20 md:p-8">
        <div className="lg:pt-[15%]">
          ...
          <p className="text-[20px] md:text-[32px] font-bold w-[65%] mx-auto text-center">
            {" "}
            “ The Essence of a Holiday is to Enrich Our Lives & Create Lasting
            Memories ”
          </p>
        </div>
      </div>
