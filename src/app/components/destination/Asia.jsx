                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    >
                        <Image
                            ...
                            height={500}
                        />
                        <div className="absolute z-10 w-full  bottom-10 text-center p-3 bg-[#B0B0B0] opacity-30 text-red-500 flex justify-center">
                            <div className="flex text-start z-20">
                                <h2><FaLocationDot className="text-4xl pt-2" /></h2>
                                <div>
                    ...
                    >
                        ...
                        <Image
                            src="/asia03.png"
                            alt="Greece"
                            className={`w-full h-full rounded-xl object-cover transition-transform duration-500 ease-in-out ${hoveredIndex === 3 ? "scale-110" : ""
                                }`}
                            width={100}
                            height={100}
                        />
                    ...
                    >
                        ...
                        <Image
                            src="/asia04.png"
                            alt="Mountain View"
                            className={`w-full h-full rounded-xl object-cover transition-transform duration-500 ease-in-out ${hoveredIndex === 4 ? "scale-110" : ""
                                }`}
                            width={100}
                            height={100}
                        />
